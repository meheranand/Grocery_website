...
//   };
  ...
  return product && (
    <div onClick={()=>navigate(`/allproducts/${product.category}/${product._id}`)} className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full">
      ...
      <div className="text-gray-500/60 text-sm">
        ...
        <div className="flex items-center gap-0.5">
          {Array(5)
            .fill("")
            .map((_, i) =>
                <img src={i<4? assets.star_icon:assets.star_dull_icon} alt="" srcset="" />             
            )}
          <p>(5)</p>
        </div>
