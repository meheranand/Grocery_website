      ...
      <div className="max-w-7xl w-full px-4 sm:px-6 lg:px-8 mt-8 sm:mt-12 md:mt-16">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 mt-4">
          <div className="flex gap-2 sm:gap-3">
            <div className="flex flex-row md:flex-col gap-2 sm:gap-3">
              {p.image.map((image, index) => (
                <div
                  ...
                  className="border max-w-16 sm:max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer"
                >
            ...
            <div className="border border-gray-500/30 max-w-40 sm:max-w-60 md:max-w-100 rounded overflow-hidden">
              <img src={thumbnail} alt="Selected p" className="w-full h-auto object-cover" />
            </div>
          </div>

          <div className="text-sm w-full md:w-1/2">
            <h1 className="text-2xl sm:text-3xl font-medium">{p.name}</h1>
            ...
            <div className="flex items-center gap-0.5 mt-1">
              ...
              <p className="text-xs sm:text-base ml-2">(5)</p>
            </div>

            <div className="mt-4 sm:mt-6">
              <p className="text-gray-500/70 line-through text-xs sm:text-base">
                MRP: ${p.price}
              </p>
              <p className="text-xl sm:text-2xl font-medium">MRP: ${p.offerprice}</p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center mt-6 sm:mt-10 gap-3 sm:gap-4 text-base">
              <button onClick={() => addproduct()} className="w-full py-2.5 sm:py-3.5 cursor-pointer font-medium bg-gray-100 text-gray-800/80 hover:bg-gray-200 transition">
                Add to Cart
              </button>
              <button onClick={() => navigate('/cart')} className="w-full py-2.5 sm:py-3.5 cursor-pointer font-medium bg-indigo-500 text-white hover:bg-indigo-600 transition">
                Buy now
              </button>
            </div>
          </div>
